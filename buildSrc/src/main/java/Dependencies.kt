object Versions {
    ...
    const val stately = "1.1.9"
    const val navComposeVersion = "2.4.0-alpha10"
    const val activityComposeVersion = "1.3.1"
    const val kotlinDateTime = "0.3.0"
    const val androidXTest = "1.4.0"
    const val androidXTestExt = "1.1.2"
    const val turbine = "0.6.1"
    const val timber = "5.0.1"
    const val dropboxCore = "4.0.1"
    const val multiplatformSettings = "0.8.1"
    const val androidCrypto = "1.1.0-alpha03"
    const val viewModelKTX = "2.4.0-rc01"
